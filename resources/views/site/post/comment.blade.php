        ...
        <li class="media">
            ...
            <div class="comment-box media-body">
                <div class="comment-meta">
                    <span class="title"><a href="#" class="url">{{ data_get($comment, 'user.first_name') }}</a> <span class="sg-date">{{ $diff = Carbon\Carbon::parse($comment->created_at)->diffForHumans() }}</span></span>
                </div>
