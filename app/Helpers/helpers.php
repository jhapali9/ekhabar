...
if (!function_exists('safari_check')) {
    ...
    {
        if (UserAgentBrowser(\Request()->header('User-Agent')) == 'Apple Safari' || UserAgentBrowser(\Request()->header('User-Agent')) == 'Safari' || UserAgentBrowser(\Request()->header('User-Agent')) == 'Internet Explorer'):
            return true;
        endif;
        return false;
    }
