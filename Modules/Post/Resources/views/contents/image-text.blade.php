            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="col-12">
                        ...
                        <input id="image_id_content" name="new_content[{{$content_count}}][image-text][image_id]" type="hidden" class="form-control image_id" value="{{isset($content)? $content['image-text'][0]['image_id']:''}}">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
