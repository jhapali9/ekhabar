<div class="add-new-page content_{{$content_count}} bg-white p-20 m-b-20">
    <div class="row">
        ...
        <div class="col-12 p-t-20 p-l-15">
            <div class="row">
                <div class="col-md-12">
                    <label for="" class="col-form-label">{{ __('vimeo_embed') }} {{ __('code') }}*</label>
                    <textarea class="form-control" name="new_content[{{$content_count}}][vimeo-embed][vimeo]" id=""
                      cols="40" rows="5">{{isset($content)? $content['vimeo-embed'][0]['vimeo']:''}}</textarea>
                </div>
            </div>
        </div>
    </div>
