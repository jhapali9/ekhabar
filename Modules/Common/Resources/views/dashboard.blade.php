                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-inline-block">
                            ...
                            <h2 class="mb-0"> {{number_format($data['totalVisits'])}}</h2>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-inline-block">
                            ...
                            <h2 class="mb-0"> {{ number_format($data['registeredUsers']) }}</h2>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-inline-block">
                            ...
                            <h2 class="mb-0">{{ number_format($data['publishedPost']) }}</h2>
                        </div>
                    ...
                    <div class="card-body border-top">
                        <div class="row">
                            ...
                            <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 p-3">
                                <h2 class="font-weight-normal mb-3"><span>{{number_format($data['totalVisits'])}}</span>                                                    </h2>
                ...
                <div class="navigation-list bg-white p-20">
                                ...
                                <div class="col-12 col-sm-6 text-right">
                                    <div class="table-info-pagination float-right">
                                        {!! $data['posthits']->onEachSide(1)->links() !!}
